...
public class State {
    ...
    //regime
    private RegimeDetector.Regime todayRegime;
...
//                ValarTrade.vixMap.put(formattedDate, currentClose + lastClosePrice);
    ...
    //regime
    public void setTodayRegime(RegimeDetector.Regime r){ this.todayRegime = r; }
    public RegimeDetector.Regime getTodayRegime(){ return todayRegime; }
}
